...
public class Render_kasumi extends Render<kasumi> {
	...
	public Render_kasumi(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(kasumi entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(kasumi entity) {
