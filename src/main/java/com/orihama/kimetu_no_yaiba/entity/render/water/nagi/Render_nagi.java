package com.orihama.kimetu_no_yaiba.entity.render.water.nagi;
...
public class Render_nagi extends Render<Nagi> {
	...
	public Render_nagi(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(Nagi entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(Nagi entity) {
