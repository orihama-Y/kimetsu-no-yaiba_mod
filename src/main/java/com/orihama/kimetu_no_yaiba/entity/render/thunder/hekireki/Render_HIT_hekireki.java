package com.orihama.kimetu_no_yaiba.entity.render.thunder.hekireki;
...
public class Render_HIT_hekireki extends Render<HIT_hekireki> {
	...
	public Render_HIT_hekireki(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(HIT_hekireki entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(HIT_hekireki entity) {
