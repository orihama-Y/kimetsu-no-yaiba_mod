...
public class Rendertukibae extends Render<tukibae> {
	...
	public Rendertukibae(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(tukibae entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(tukibae entity) {
