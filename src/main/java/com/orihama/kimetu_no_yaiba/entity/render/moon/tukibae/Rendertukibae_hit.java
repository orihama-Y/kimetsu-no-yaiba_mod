package com.orihama.kimetu_no_yaiba.entity.render.moon.tukibae;
...
public class Rendertukibae_hit extends Render<tukibae_hit> {
	...
	public Rendertukibae_hit(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(tukibae_hit entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(tukibae_hit entity) {
