...
public class Render_lightning extends Render<lightning_custom>
{
    public Render_lightning(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(lightning_custom entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Nullable
    protected ResourceLocation getEntityTexture(lightning_custom entity)
    {
        return null;
    }
}