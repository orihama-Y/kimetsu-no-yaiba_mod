package com.orihama.kimetu_no_yaiba.entity.render.insect.tawamure;
...
public class Render_tawamure extends Render<tawamure> {
	...
	public Render_tawamure(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(tawamure entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(tawamure entity) {
