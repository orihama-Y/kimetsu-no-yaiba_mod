package com.orihama.kimetu_no_yaiba.entity.render.mist.oboro;
...
public class Render_oboro_slash extends Render<oboro> {
	...
	public Render_oboro_slash(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(oboro entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(oboro entity) {
