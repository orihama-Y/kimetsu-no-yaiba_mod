...
public class Renderkataware_hit extends Render<kataware_hit> {
	...
	public Renderkataware_hit(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(kataware_hit entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(kataware_hit entity) {
