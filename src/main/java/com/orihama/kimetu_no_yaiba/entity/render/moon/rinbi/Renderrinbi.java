package com.orihama.kimetu_no_yaiba.entity.render.moon.rinbi;
...
public class Renderrinbi extends Render<rinbi> {
	...
	public Renderrinbi(RenderManager renderManager) {
		super(renderManager);
	}

	public void doRender(rinbi entity, double x, double y, double z, float entityYaw, float partialTicks) {
	...
	@Override
	protected ResourceLocation getEntityTexture(rinbi entity) {
