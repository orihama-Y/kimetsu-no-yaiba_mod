...
public abstract class abs_tukibae_hit extends Entity
{
	...
	public abs_tukibae_hit(World worldIn) {
		super(worldIn);
	}
	...
	public abs_tukibae_hit(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn);
		setSize(4.0F, 4.0F);
		setPosition(x, y, z);
	}

	public abs_tukibae_hit(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
		super(worldIn);
