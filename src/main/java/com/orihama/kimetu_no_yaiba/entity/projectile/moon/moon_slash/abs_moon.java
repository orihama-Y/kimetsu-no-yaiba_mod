...
public abstract class abs_moon
extends Entity
{
	...
	public abs_moon(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn);
		setSize(60.0F, 10.0F);
	...
	public abs_moon(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
		super(worldIn);
	...
	public void onUpdate() {
		...
		if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
			...
			this.world.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL,this.posX+(0.4 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)), 0.0D, 0.0D, 0.0D, new int[0]);
		   	particle_spawns.spawnParticle(particle_enum.MOON1,this.posX+(0.4 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON2,this.posX+(0.4 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON3,this.posX+(0.4 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
			}
