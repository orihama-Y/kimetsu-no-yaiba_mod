...
public class tukibae extends abs_tukibae{
	public int explosionPower = 2;

	public tukibae(World worldIn) {
		super(worldIn);
	}

	@SideOnly(Side.CLIENT)
	public tukibae(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn, x, y, z, accelX, accelY, accelZ);
	}

	public tukibae(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
