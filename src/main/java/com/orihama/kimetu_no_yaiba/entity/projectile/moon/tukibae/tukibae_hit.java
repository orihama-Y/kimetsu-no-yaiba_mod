...
public class tukibae_hit extends abs_tukibae_hit{
	public int explosionPower = 2;

	public tukibae_hit(World worldIn) {
		super(worldIn);
	}

	@SideOnly(Side.CLIENT)
	public tukibae_hit(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn, x, y, z, accelX, accelY, accelZ);
	}

	public tukibae_hit(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
	...
	protected void onImpact(RayTraceResult result) {
		if (!this.getEntityWorld().isRemote)
			 ...
			 if (!(result.entityHit == this.shootingEntity) &&
				...
				this.world.createExplosion(this, this.posX, this.posY, this.posZ, this.explosionPower * 0.8F, bool);
			}
