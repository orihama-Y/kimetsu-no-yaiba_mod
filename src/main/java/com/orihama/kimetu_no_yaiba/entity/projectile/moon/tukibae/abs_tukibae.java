package com.orihama.kimetu_no_yaiba.entity.projectile.moon.tukibae;
...
public abstract class abs_tukibae extends Entity
{
	...
	public abs_tukibae(World worldIn) {
		super(worldIn);
	}
	...
	public abs_tukibae(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn);
		setSize(4.0F, 4.0F);
		setPosition(x, y, z);
	}

	public abs_tukibae(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
		super(worldIn);
	...
	public void onUpdate() {
		...
		if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
			...
			if(this.world.isRemote){
				particle_spawns.spawnParticle(particle_enum.MOON1B,this.posX+(0.3 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   		particle_spawns.spawnParticle(particle_enum.MOON2B,this.posX+(0.3 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   		particle_spawns.spawnParticle(particle_enum.MOON3B,this.posX+(0.3 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.3 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
			}
