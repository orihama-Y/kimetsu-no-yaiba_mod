...
public abstract class abs_kataware extends Entity
{
	...
	public abs_kataware(World worldIn) {
		super(worldIn);
	}
	...
	public abs_kataware(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
		super(worldIn);
		setSize(4.0F, 4.0F);
		setPosition(x, y, z);
	}

	public abs_kataware(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
		super(worldIn);
	...
	public void onUpdate() {
		...
		if (this.world.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.world.isBlockLoaded(new BlockPos(this)))) {
			...
			particle_spawns.spawnParticle(particle_enum.MOON1B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON2B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON3B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
			particle_spawns.spawnParticle(particle_enum.MOON1B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON2B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
		   	particle_spawns.spawnParticle(particle_enum.MOON3B,this.posX+(0.1 * r.nextInt(5)), this.posY +(0.1 * r.nextInt(5)), this.posZ+(0.1 * r.nextInt(5)),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F),((this.rand.nextFloat() - 0.5F) * 0.4F));
			}
