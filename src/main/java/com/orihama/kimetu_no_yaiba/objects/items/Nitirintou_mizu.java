...
public class Nitirintou_mizu extends ItemSword implements IHasModel {
	int tick = 0, tick2 = 0;
	float x=0f;
	...
	public Nitirintou_mizu(Item.ToolMaterial material) {
		super(material);
		setUnlocalizedName("nitirintou_mizu");
		setRegistryName("nitirintou_mizu");
